...
<div class="dropAdbox">
          ...
          <!-- <input type="text" class="form-control" name="category" placeholder="Category" required> -->
             <select name="category">
                 ...
                 <!--	<div class="form-group col-md-offset-1 col-md-10">
			Description:
                            <textarea class="form-control" name="description" placeholder="Ad description"  style="height: 80px; width: 100%; resize: none; overflow-y: hidden;"
            ...
            <input type="number" id="pricevalue" class="form-control" name="amount" placeholder="Expected price(example:600.00 or 200.50 etc.)" onblur="price_val()" required>
          ...
          <input type="number" id="phonevalue" class="form-control" name="number" placeholder="Contact No." onblur="phone_val()">
			...
			Your Feedback<b style="color:red">*</b>:
                 ...
                 <input type="submit" class="btn btn-success col-md-offset-1" name="adSubmit" value="Submit" onclick="alert('We will verify your details and your ad will be posted soon')"/>            
			</form>
</div>		
